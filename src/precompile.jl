function _precompile_()
    ...
    isdefined(Comonicon, Symbol("##LeafCommand#11")) && precompile(
        Tuple{
    ...
    isdefined(Comonicon, Symbol("##partition#12")) && precompile(
        Tuple{
    ...
    isdefined(Comonicon, Symbol("##xcall#6")) && precompile(
        Tuple{
    ...
    isdefined(Comonicon, Symbol("##xcall#7")) && precompile(
        Tuple{
    ...
    isdefined(Comonicon, Symbol("##xcall#8")) && precompile(
        Tuple{
    ...
    isdefined(Comonicon, Symbol("##xcall#9")) && precompile(
        Tuple{
    ...
    isdefined(Comonicon, Symbol("#cmd_script##kw")) && precompile(
        Tuple{
    ...
    isdefined(Comonicon, Symbol("#command##kw")) && precompile(
        Tuple{
    ...
    isdefined(Comonicon, Symbol("#install##kw")) && precompile(
        Tuple{
    ...
    isdefined(Comonicon, Symbol("#xcall##kw")) && precompile(
        Tuple{
    ...
    precompile(
        Tuple{typeof(Comonicon.CodeGen.codegen),Comonicon.CodeGen.ASTCtx,Comonicon.Types.LeafCommand},
    )
    precompile(
        Tuple{typeof(Comonicon.CodeGen.codegen),Comonicon.CodeGen.ASTCtx,Comonicon.Types.NodeCommand},
    )
    precompile(
        Tuple{
    ...
    precompile(
        Tuple{typeof(Comonicon.Parse.set_cmd!),Base.Dict{String,Any},Comonicon.Types.LeafCommand},
    )
