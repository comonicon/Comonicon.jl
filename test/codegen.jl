...
cmd_sin = LeafCommand(test_sin; args=[Arg("theta")], options=[opt], doc="sdasdbsa dasdioasdmasd dsadas")
cmd_cos = LeafCommand(test_cos; args=[Arg("theta"; type=AbstractFloat)], doc="dasdas dasidjmoasid dasdasd dasdasd dasd dasd")
cmd1 = NodeCommand("foo", [cmd_sin, cmd_cos]; doc="asdasd asdasd asd asdasd asdas asdasd dasdas")
cmd2 = NodeCommand("goosadas", [LeafCommand(test_tanh; args=[Arg("theta"; type=Real)])], doc="asdasdasdasdfunuikasnsdasdasdasdas")
